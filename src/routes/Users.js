...
const Users = () => {
  ...
  //   const cmd = {
  //     pactCode: "(basic-payment.db-insert 'jerome123 'Jerome 200.00 'Developer (read-keyset 'jeromebacatan-keyset))",
  //     keyPairs: {
  ...
  //     },
  //     envData: {
  //       'jeromebacatan-keyset': {
  //         keys: ["1853c995c7d69283f3eecadfb32e3f69da7f615bcffbe342d2c0fd9e5949d4f6"],
  //         pred: 'keys-any'
  //       }
  //     },
  //   }
